package piotr.hadala.userservice.config.security;
...
class JwtAuthenticationFilter extends HttpFilter {
    private static final RequestMatcher DEFAULT_ANT_PATH_REQUEST_MATCHER = new AntPathRequestMatcher("/api/oauth/token", "POST", false);
