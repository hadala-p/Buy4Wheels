...
import piotr.hadala.userservice.domain.user.dto.UserCredentialsDto;
...
public class UserService {
    ...
    public UserMinimalDto registerUserWithDefaultRole(UserRegistrationDto userRegistration) {
        ...
        return new UserMinimalDto(user.getId(), user.getEmail());
    }
}